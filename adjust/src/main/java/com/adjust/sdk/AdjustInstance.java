...
public class AdjustInstance {
    public static class PreLaunchActions {
        public List<com.adjust.sdk.IRunActivityHandler> preLaunchActionsArray;
        public List<com.adjust.sdk.AdjustThirdPartySharing> preLaunchAdjustThirdPartySharingArray;
    ...
    public void onCreate(final AdjustConfig adjustConfig) {
        ...
        Context finalContext = adjustConfig.context;
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Utils.startCounter(finalContext);
            }
        }, 200);
    ...
    public void addSessionCallbackParameter(final String key, final String value) {
        ...
        preLaunchActions.preLaunchActionsArray.add(new com.adjust.sdk.IRunActivityHandler() {
            @Override
            public void run(final com.adjust.sdk.ActivityHandler activityHandler) {
    ...
    private void saveRawReferrer(final String rawReferrer, final long clickTime, final Context context) {
        com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(context).saveRawReferrer(rawReferrer, clickTime);
    }
    ...
    private void savePreinstallReferrer(final String referrer, final Context context) {
        com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(context).savePreinstallReferrer(referrer);
    }
    ...
    private void savePushToken(final String pushToken, final Context context) {
        com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(context).savePushToken(pushToken);
    }
    ...
    private void saveDisableThirdPartySharing(final Context context) {
        com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(context).setDisableThirdPartySharing();
    }
    ...
    private void saveDeeplink(final Uri deeplink, final long clickTime, final Context context) {
        com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(context).saveDeeplink(deeplink, clickTime);
    }
    ...
    public void setTestOptions(AdjustTestOptions testOptions) {
        ...
        if (testOptions.noBackoffWait != null) {
            AdjustFactory.setPackageHandlerBackoffStrategy(com.adjust.sdk.BackoffStrategy.NO_WAIT);
