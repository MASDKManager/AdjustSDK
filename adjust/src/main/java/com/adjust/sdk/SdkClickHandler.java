...
public class SdkClickHandler implements ISdkClickHandler {
     ...
     * Sending queue.
     */
    private List<com.adjust.sdk.ActivityPackage> packageQueue;
     ...
     */
    private WeakReference<com.adjust.sdk.IActivityHandler> activityHandlerWeakRef;
     ...
     */
    public SdkClickHandler(final com.adjust.sdk.IActivityHandler activityHandler,
     ...
     */
    @Override
    public void init(final com.adjust.sdk.IActivityHandler activityHandler,
                     final boolean startsSending,
                     final IActivityPackageSender sdkClickHandlerActivityPackageSender) {
        paused = !startsSending;
        packageQueue = new ArrayList<com.adjust.sdk.ActivityPackage>();
        activityHandlerWeakRef = new WeakReference<com.adjust.sdk.IActivityHandler>(activityHandler);
     ...
     */
    @Override
    public void sendSdkClick(final com.adjust.sdk.ActivityPackage sdkClick) {
    ...
    public void sendReftagReferrers() {
        scheduler.submit(new Runnable() {
            @Override
            public void run() {
                com.adjust.sdk.IActivityHandler activityHandler = activityHandlerWeakRef.get();
                com.adjust.sdk.SharedPreferencesManager sharedPreferencesManager = com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(
                ...
                try {
                    ...
                    for (int i = 0; i < rawReferrerArray.length(); i++) {
                        ...
                        // Create sdk click
                        com.adjust.sdk.ActivityPackage sdkClickPackage = PackageFactory.buildReftagSdkClickPackage(
    ...
    public void sendPreinstallPayload(final String preinstallPayload, final String preinstallLocation) {
        scheduler.submit(new Runnable() {
            ...
            public void run() {
                ...
                // Create sdk click
                com.adjust.sdk.ActivityPackage sdkClickPackage = PackageFactory.buildPreinstallSdkClickPackage(
                        preinstallPayload,
                        preinstallLocation,
                        activityHandler.getActivityState(),
                        activityHandler.getAdjustConfig(),
    ...
    private void sendNextSdkClickI() {
        ...
        final com.adjust.sdk.ActivityPackage sdkClickPackage = packageQueue.remove(0);
     ...
     */
    private void sendSdkClickI(final com.adjust.sdk.ActivityPackage sdkClickPackage) {
        ...
        if (isReftag) {
            ...
            JSONArray rawReferrer = com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(activityHandler.getContext()).getRawReferrer(
                    rawReferrerString,
        ...
        boolean isPreinstall = source != null && source.equals(com.adjust.sdk.Constants.PREINSTALL);
        ...
        com.adjust.sdk.SdkClickResponseData sdkClickResponseData = (SdkClickResponseData)responseData;
        ...
        if (isReftag) {
            ...
            com.adjust.sdk.SharedPreferencesManager.getDefaultInstance(
     ...
     */
    private void retrySendingI(final com.adjust.sdk.ActivityPackage sdkClickPackage) {
