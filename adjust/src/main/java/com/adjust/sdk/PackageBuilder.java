...
public class PackageBuilder {
    ...
    private class ActivityStateCopy {
        ...
        ActivityStateCopy(com.adjust.sdk.ActivityState activityState) {
    ...
    com.adjust.sdk.ActivityPackage buildSessionPackage(boolean isInDelay) {
        Map<String, String> parameters = getSessionParameters(isInDelay);
        com.adjust.sdk.ActivityPackage sessionPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.SESSION);
        sessionPackage.setPath("/session");
        sessionPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.SESSION.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildEventPackage(com.adjust.sdk.AdjustEvent event, boolean isInDelay) {
        Map<String, String> parameters = getEventParameters(event, isInDelay);
        com.adjust.sdk.ActivityPackage eventPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.EVENT);
        eventPackage.setPath("/event");
        eventPackage.setSuffix(getEventSuffix(event));

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.EVENT.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildInfoPackage(String source) {
        Map<String, String> parameters = getInfoParameters(source);
        com.adjust.sdk.ActivityPackage infoPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.INFO);
        infoPackage.setPath("/sdk_info");
        infoPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.INFO.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildClickPackage(String source) {
        Map<String, String> parameters = getClickParameters(source);
        com.adjust.sdk.ActivityPackage clickPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.CLICK);
        ...
        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.CLICK.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildAttributionPackage(String initiatedByDescription) {
        Map<String, String> parameters = getAttributionParameters(initiatedByDescription);
        com.adjust.sdk.ActivityPackage attributionPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.ATTRIBUTION);
        attributionPackage.setPath("attribution"); // does not contain '/' because of Uri.Builder.appendPath
        attributionPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.ATTRIBUTION.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildGdprPackage() {
        Map<String, String> parameters = getGdprParameters();
        com.adjust.sdk.ActivityPackage gdprPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.GDPR);
        gdprPackage.setPath("/gdpr_forget_device");
        gdprPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.GDPR.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildDisableThirdPartySharingPackage() {
        Map<String, String> parameters = getDisableThirdPartySharingParameters();
        com.adjust.sdk.ActivityPackage activityPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.DISABLE_THIRD_PARTY_SHARING);
        activityPackage.setPath("/disable_third_party_sharing");
        activityPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.DISABLE_THIRD_PARTY_SHARING.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildThirdPartySharingPackage(
            final com.adjust.sdk.AdjustThirdPartySharing adjustThirdPartySharing)
    {
        Map<String, String> parameters = getThirdPartySharingParameters(adjustThirdPartySharing);
        com.adjust.sdk.ActivityPackage activityPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.THIRD_PARTY_SHARING);
        activityPackage.setPath("/third_party_sharing");
        activityPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.THIRD_PARTY_SHARING.toString(),
                activityPackage.getClientSdk(), adjustConfig.context, adjustConfig.logger);
    ...
    com.adjust.sdk.ActivityPackage buildMeasurementConsentPackage(final boolean consentMeasurement) {
        ...
        com.adjust.sdk.ActivityPackage activityPackage =
                getDefaultActivityPackage(com.adjust.sdk.ActivityKind.MEASUREMENT_CONSENT);
        activityPackage.setPath("/measurement_consent");
        activityPackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.MEASUREMENT_CONSENT.toString(),
                activityPackage.getClientSdk(), adjustConfig.context, adjustConfig.logger);
    ...
    com.adjust.sdk.ActivityPackage buildAdRevenuePackage(String source, JSONObject adRevenueJson) {
        Map<String, String> parameters = getAdRevenueParameters(source, adRevenueJson);
        com.adjust.sdk.ActivityPackage adRevenuePackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.AD_REVENUE);
        adRevenuePackage.setPath("/ad_revenue");
        adRevenuePackage.setSuffix("");

        com.adjust.sdk.AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.AD_REVENUE.toString(),
    ...
    com.adjust.sdk.ActivityPackage buildAdRevenuePackage(com.adjust.sdk.AdjustAdRevenue adjustAdRevenue, boolean isInDelay) {
    ...
    com.adjust.sdk.ActivityPackage buildSubscriptionPackage(com.adjust.sdk.AdjustPlayStoreSubscription subscription, boolean isInDelay) {
        Map<String, String> parameters = getSubscriptionParameters(subscription, isInDelay);
        com.adjust.sdk.ActivityPackage subscriptionPackage = getDefaultActivityPackage(com.adjust.sdk.ActivityKind.SUBSCRIPTION);
        subscriptionPackage.setPath("/v2/purchase");
        subscriptionPackage.setSuffix("");

        AdjustSigner.sign(parameters, com.adjust.sdk.ActivityKind.SUBSCRIPTION.toString(),
    ...
    private Map<String, String> getSessionParameters(boolean isInDelay) {
        ...
        Map<String, String> imeiParameters = com.adjust.sdk.Util.getImeiParameters(adjustConfig, logger);
        ...
        Map<String, String> oaidParameters = com.adjust.sdk.Util.getOaidParameters(adjustConfig, logger);
        ...
        PackageBuilder.addString(parameters, "fire_adid", com.adjust.sdk.Util.getFireAdvertisingId(adjustConfig));
        PackageBuilder.addBoolean(parameters, "fire_tracking_enabled", com.adjust.sdk.Util.getFireTrackingEnabled(adjustConfig));
        ...
        PackageBuilder.addLong(parameters, "connectivity_type", com.adjust.sdk.Util.getConnectivityType(adjustConfig.context));
        ...
        PackageBuilder.addString(parameters, "mcc", com.adjust.sdk.Util.getMcc(adjustConfig.context));
        PackageBuilder.addString(parameters, "mnc", com.adjust.sdk.Util.getMnc(adjustConfig.context));
    ...
    public Map<String, String> getEventParameters(com.adjust.sdk.AdjustEvent event, boolean isInDelay) {
        Map<String, String> parameters = new HashMap<String, String>();
        Map<String, String> imeiParameters = com.adjust.sdk.Util.getImeiParameters(adjustConfig, logger);
        ...
        // Callback and partner parameters.
        if (!isInDelay) {
            PackageBuilder.addMapJson(parameters, "callback_params", com.adjust.sdk.Util.mergeParameters(this.sessionParameters.callbackParameters, event.callbackParameters, "Callback"));
            PackageBuilder.addMapJson(parameters, "partner_params", com.adjust.sdk.Util.mergeParameters(this.sessionParameters.partnerParameters, event.partnerParameters, "Partner"));
        }
    ...
    private Map<String, String> getAdRevenueParameters(AdjustAdRevenue adjustAdRevenue, boolean isInDelay) {
        ...
        // Callback and partner parameters.
        if (!isInDelay) {
            PackageBuilder.addMapJson(parameters, "callback_params", com.adjust.sdk.Util.mergeParameters(this.sessionParameters.callbackParameters, adjustAdRevenue.callbackParameters, "Callback"));
            PackageBuilder.addMapJson(parameters, "partner_params", com.adjust.sdk.Util.mergeParameters(this.sessionParameters.partnerParameters, adjustAdRevenue.partnerParameters, "Partner"));
        }
    ...
    private Map<String, String> getSubscriptionParameters(AdjustPlayStoreSubscription subscription, boolean isInDelay) {
        ...
        // Callback and partner parameters.
        if (!isInDelay) {
            PackageBuilder.addMapJson(parameters, "callback_params", com.adjust.sdk.Util.mergeParameters(this.sessionParameters.callbackParameters, subscription.getCallbackParameters(), "Callback"));
            PackageBuilder.addMapJson(parameters, "partner_params", com.adjust.sdk.Util.mergeParameters(this.sessionParameters.partnerParameters, subscription.getPartnerParameters(), "Partner"));
        }
    ...
    private com.adjust.sdk.ActivityPackage getDefaultActivityPackage(ActivityKind activityKind) {
        com.adjust.sdk.ActivityPackage activityPackage = new ActivityPackage(activityKind);
    ...
    private static void addDate(Map<String, String> parameters, String key, Date value) {
        ...
        String dateString = com.adjust.sdk.Util.dateFormatter.format(value);
    ...
    private static void addDouble(Map<String, String> parameters, String key, Double value) {
        ...
        String doubleString = com.adjust.sdk.Util.formatString("%.5f", value);
    ...
    private String getEventSuffix(AdjustEvent event) {
        if (event.revenue == null) {
            return com.adjust.sdk.Util.formatString("'%s'", event.eventToken);
        } else {
