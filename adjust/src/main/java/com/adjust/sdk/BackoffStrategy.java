...
public enum BackoffStrategy {
    LONG_WAIT(1,                        // min retries
            2 * com.adjust.sdk.Constants.ONE_MINUTE,   // milliseconds multiplier
            24 * com.adjust.sdk.Constants.ONE_HOUR,    // max wait time
    ...
    SHORT_WAIT(1,                   // min retries
            ...
            com.adjust.sdk.Constants.ONE_HOUR,     // max wait time
            0.5,                    // min jitter multiplier
            1.0),                   // max jitter multiplier
