...
public class AdjustEvent {
    ...
    private static com.adjust.sdk.ILogger logger = AdjustFactory.getLogger();
    ...
    public void addCallbackParameter(String key, String value) {
        if (!com.adjust.sdk.Util.isValidParameter(key, "key", "Callback")) return;
        if (!com.adjust.sdk.Util.isValidParameter(value, "value", "Callback")) return;
    ...
    public void addPartnerParameter(String key, String value) {
        if (!com.adjust.sdk.Util.isValidParameter(key, "key", "Partner")) return;
