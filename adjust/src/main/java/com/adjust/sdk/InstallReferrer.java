...
public class InstallReferrer implements InvocationHandler {
     ...
     */
    public InstallReferrer(final Context context, final com.adjust.sdk.InstallReferrerReadListener referrerCallback) {
    ...
    private Object createInstallReferrer(Context context, com.adjust.sdk.InstallReferrerReadListener referrerCallback, com.adjust.sdk.ILogger logger) {
        ...
        switch (responseCode) {
            ...
            case STATUS_OK:
                ...
                try {
                    ...
                    com.adjust.sdk.ReferrerDetails installReferrerDetails = new ReferrerDetails(installReferrer,
                    ...
                    referrerCallback.onInstallReferrerRead(installReferrerDetails, com.adjust.sdk.Constants.REFERRER_API_GOOGLE);
                } catch (Exception e) {
    ...
    private void retryI() {
        ...
        if (retries + 1 > com.adjust.sdk.Constants.MAX_INSTALL_REFERRER_RETRIES) {
