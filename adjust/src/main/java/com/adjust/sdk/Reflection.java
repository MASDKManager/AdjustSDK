...
public class Reflection {
    ...
    static Map<String, String> getImeiParameters(Context context, com.adjust.sdk.ILogger logger) {
        Object nonPlayParameters = null;
        try {
            nonPlayParameters = invokeStaticMethod("com.adjust.sdk.imei.Util", "getImeiParameters", new Class[]{Context.class, com.adjust.sdk.ILogger.class}, context, logger);
    ...
    static Map<String, String> getOaidParameters(Context context, com.adjust.sdk.ILogger logger) {
        Object oaidParameters = null;
        try {
            oaidParameters = invokeStaticMethod("com.adjust.sdk.oaid.Util", "getOaidParameters", new Class[]{Context.class, com.adjust.sdk.ILogger.class}, context, logger);
            Class<Map<String, String>> stringStringMapClass = (Class<Map<String, String>>) (Class) Map.class;
    ...
    public static com.adjust.sdk.ReferrerDetails getXiaomiReferrer(Context context, com.adjust.sdk.ILogger logger) {
        com.adjust.sdk.ReferrerDetails referrerDetails = null;
        try {
