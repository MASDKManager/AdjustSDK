...
public class AdjustSigner {
    ...
    public static void enableSigning(com.adjust.sdk.ILogger logger) {
        getSignerInstance();
    ...
    public static void disableSigning(com.adjust.sdk.ILogger logger) {
        getSignerInstance();
    ...
    public static void onResume(com.adjust.sdk.ILogger logger){
        getSignerInstance();
