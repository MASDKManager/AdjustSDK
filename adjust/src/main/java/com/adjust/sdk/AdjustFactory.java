...
public class AdjustFactory {
    ...
    public static com.adjust.sdk.IPackageHandler getPackageHandler(
            com.adjust.sdk.IActivityHandler activityHandler,
            Context context,
            boolean startsSending,
            IActivityPackageSender packageHandlerActivityPackageSender)
    {
        if (packageHandler == null) {
            return new com.adjust.sdk.PackageHandler(activityHandler,
                    context,
                    startsSending,
    ...
    public static long getTimerInterval() {
        if (timerInterval == -1) {
            return com.adjust.sdk.Constants.ONE_MINUTE;
        }
    ...
    public static long getSessionInterval() {
        if (sessionInterval == -1) {
            return com.adjust.sdk.Constants.THIRTY_MINUTES;
        }
    ...
    public static com.adjust.sdk.BackoffStrategy getSdkClickBackoffStrategy() {
        if (sdkClickBackoffStrategy == null) {
            return com.adjust.sdk.BackoffStrategy.SHORT_WAIT;
        }
    ...
    public static com.adjust.sdk.BackoffStrategy getPackageHandlerBackoffStrategy() {
        if (packageHandlerBackoffStrategy == null) {
            return com.adjust.sdk.BackoffStrategy.LONG_WAIT;
        }
    ...
    public static com.adjust.sdk.IActivityHandler getActivityHandler(AdjustConfig config) {
        if (activityHandler == null) {
            return com.adjust.sdk.ActivityHandler.getInstance(config);
        }
        activityHandler.init(config);
        return activityHandler;
    }

    public static com.adjust.sdk.IAttributionHandler getAttributionHandler(
            com.adjust.sdk.IActivityHandler activityHandler,
            boolean startsSending,
            IActivityPackageSender packageHandlerActivityPackageSender)
    {
    ...
    public static com.adjust.sdk.ISdkClickHandler getSdkClickHandler(
            com.adjust.sdk.IActivityHandler activityHandler,
            boolean startsSending,
            IActivityPackageSender packageHandlerActivityPackageSender)
    {
    ...
    public static long getMaxDelayStart() {
        if (maxDelayStart == -1) {
            return com.adjust.sdk.Constants.ONE_SECOND * 10; // 10 seconds
        }
    ...
    public static void setSdkClickBackoffStrategy(com.adjust.sdk.BackoffStrategy sdkClickBackoffStrategy) {
    ...
    public static void enableSigning() {
        com.adjust.sdk.AdjustSigner.enableSigning(getLogger());
    }
