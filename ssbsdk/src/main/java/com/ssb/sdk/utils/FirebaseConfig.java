...
import com.ssb.sdk.models.AdjustRC;
import com.ssb.sdk.models.FacebookRC;
import com.ssb.sdk.models.Params;
import com.ssb.sdk.models.deeplink.DeeplinkRC;
import com.ssb.sdk.models.PreventAttribution;
...
import com.ssb.sdk.BuildConfig;
import com.ssb.sdk.models.PList;
...
public class FirebaseConfig {
    ...
    public boolean use_only_deeplink = false;
        ...
        mFirebaseRemoteConfig.fetchAndActivate()
            .addOnCompleteListener(context, new OnCompleteListener<Boolean>() {
                ...
                public void onComplete(@NonNull Task<Boolean> task) {
                    ...
                    use_only_deeplink = mFirebaseRemoteConfig.getBoolean("use_only_deeplink");
                    ...
                    params = mFirebaseRemoteConfig.getString("params");
                    facebook = mFirebaseRemoteConfig.getString("facebook");
